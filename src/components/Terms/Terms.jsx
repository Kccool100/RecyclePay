        ...
        <div className='tems-container'>
            ...
            <div className='termstext'>
                ...
                <p>	•	Users are responsible for ensuring that the waste is properly sorted and accessible for collection at the agreed pickup time.</p>
                  ...
                  <p>	•	RecyclePay reserves the right to verify the weight of recyclables upon collection. If it is found that a user has misrepresented the weight of their recyclables or
                 attempted to schedule a pickup below the minimum weight of 10kg, the user’s account will be flagged for review</p>
                  <p>	•	Penalty for False Reporting: Any user found to have deliberately falsified the weight of their recyclables will have their account permanently blocked from the
                   RecyclePay platform, and any pending payments will be withheld.</p>
                   ...
                   <p>. Anoid harassment, or fraudulent activities toward RecyclePay employees or other users will result in the immediate termination of the user’s account</p>
                    <h1>6.⁠ ⁠Termination</h1>
                    <p>	•	RecyclePay reserves the right to terminate or suspend any account that violates these terms and conditions, engages in fraudulent activity, or otherwise misuses the 
                    platform.</p>
                    <h1>7.⁠ ⁠Privacy</h1>
                    <p>	•	All personal information provided to RecyclePay will be handled in accordance with our privacy policy. We are committed to protecting your data and ensuring your 
                    privacy.</p>
